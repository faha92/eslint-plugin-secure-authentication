        ...
        if (
          ...
          context.report({
            ...
            fix(fixer) {
              ...
              const variableDeclarationNode = node.parent.parent.parent;
              ...
              const lastImportNode = context.getSourceCode().ast.body.filter(n => n.type === 'ImportDeclaration' || n.type === 'VariableDeclaration').pop();
              const lastImportEnd = lastImportNode.range[1];
              fixes.push(
                fixer.insertTextAfterRange([lastImportEnd, lastImportEnd], `\n${hashedPasswordDeclaration}`),
