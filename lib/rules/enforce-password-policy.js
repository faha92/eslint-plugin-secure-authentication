...
module.exports = {
  ...
  create(context) {
    ...
    if (!schema.validate(password)) {
      errors.push({ msg: "Password can't be a common password and must be at least 8 characters long and include uppercase and lowercase letters, as well as at least one special character" });
    }
                `
              );
